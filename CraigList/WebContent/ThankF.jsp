				...
				<div class="row">
					<div class="col-md-12 text-center">
						...
						<h2 class="display-3 text-black font-heading-serif">Thank
							you for Your Feedback!</h2>
						<p class="lead mb-5">Your Thoughts are Highly Valued by Craigslist!!</p>
						<p>
							<a href="index.jsp"
								class="btn btn-md height-auto px-4 py-3 btn-primary">Back to
								Home</a>
								<a href="feedbackView.jsp"
								class="btn btn-md height-auto px-4 py-3 btn-primary">View Other Feedbacks</a>
						</p>
					</div>
				</div>
			</div>
